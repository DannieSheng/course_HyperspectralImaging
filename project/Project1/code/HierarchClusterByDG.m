function [transform, ClustsFlag, ClustMems, ClustVecs, KLDMat, Hists] = HierarchClusterByDG(X, Wvs,Parameters)
...
transform.clusts    = Clusts;
transform.parameter = Parameters;
%%
%%% ERROR CHECKING: %%%%
