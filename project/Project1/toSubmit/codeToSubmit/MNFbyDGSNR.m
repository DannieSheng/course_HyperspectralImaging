function  [Y, YVecs, Cnb, Cn, transform] = MNFbyDGSNR(X, Parameters, varargin)
% function [Y, YVecs, Cn, ReconX, W, L] = MNFbyDGSNR(X, Parameters, varargin)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Cn      = cov(SubNbrs);
Cnb     = Cn; %covariance of noise before diagonal load
...
% ReconX = permute(reshape(fliplr(ReconX), [NCols, NRows,B]), [2,1,3]);
%%
